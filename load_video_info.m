...
if exist([video_path num2str(frames{1},'img/img%05i.png')], 'file'),
    video_path = [video_path 'img/'];
    img_files = num2str((frames{1} : frames{2})', [video_path 'img%05i.png']);
elseif exist([video_path num2str(frames{1}, 'img/%04i.jpg')], 'file'),
    video_path = [video_path 'img/'];
    img_files = num2str((frames{1} : frames{2})', [video_path '%04i.jpg']);
elseif exist([video_path num2str(frames{1}, 'img/img%05i.jpg')], 'file'),
    video_path = [video_path 'img/'];
    img_files = num2str((frames{1} : frames{2})', [video_path 'img%05i.jpg']);
elseif exist([video_path num2str(frames{1}, 'img/img%05i.bmp')], 'file'),
    video_path = [video_path 'img/'];
